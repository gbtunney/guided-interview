...
Define a human-first, design-time attribute specification format that sits before schemas, databases, APIs, or UI frameworks.

It is meant for thinking, documenting, and standardizing fields consistently across projects.
...
- Semantic meaning is captured via constraints, UI choice, and optional description
...
4. Presence Is Separate From Type
...
6. UI Components as Hints, Not Contracts
...
7. Reference Object Convention

  

  

When references are modeled as objects (instead of raw IDs), a minimal standard is suggested:
...
Nullable, UI flags, and platform mappings are intentionally not part of the default flow.
